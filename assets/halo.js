(function ($) {
    ...
    if (!$('#shopify-section-collection-template-supermarket').length) {
                                    ...
                                    if (layout == 'carousel') {
                                        ...
                                        if(productGrid.not('.slick-initialized')) {
                                            productGrid.slick({
                                                ...
                                                get dots() {
                                                    if((self.hasClass('has-banner')) || (window.layout_style == 'layout_style_suppermarket')){
                                                        return this.dots = true;
                                                    }else {
                                                        return this.dots = false;
                                                    };
        ...
        changeSwatchQs: function () {
            $('.selector-wrapper :radio').on('change', function(e){
                ...
                if (selectedVariant.compare_at_price > selectedVariant.price) {
                    productItemLayout.find('[data-compare-price-grid]').html(Shopify.formatMoney(selectedVariant.compare_at_price, window.money_format));
                } else {
                    productItemLayout.find('[data-compare-price-grid]').html('');
                }
                productItemLayout.find('[data-price-grid]').html(Shopify.formatMoney(selectedVariant.price, window.money_format));
...
//                     productItemElm.find('[data-value="' + title + '"]').find('label').trigger('click');
        ...
        initProductMoreview: function (productMoreview) {
            ...
            //         var video = sliderFor.find('video').get(0);
            //         console.log(video);
            //         video.pause();
            //     }
        ...
        initBundleProducts: function() {
            ...
            var bundleSlider = function() {
                if(bundleImagesSlide.length && bundleImagesSlide.not('.slick-initialized')) {
                    if ((window.layout_style == 'layout_style_1170') || (window.layout_style == 'layout_style_fullwidth') || (window.layout_style == 'layout_style_flower') || (window.layout_style == 'layout_style_suppermarket')) {
                        if(window.product_style == 'skin_1') {
                            var images = 3;
                        } else if(window.product_style == 'supermarket') {
                            var images = 4;
                    ...
                    bundleImagesSlide.slick({
                        ...
                        responsive: [
                            ...
                            },
                            {
                                ...
                                settings: {
                                    get slidesToShow() {
                                        if ((window.layout_style == 'layout_style_1170') || (window.layout_style == 'layout_style_fullwidth') || (window.layout_style == 'layout_style_suppermarket')) {
                                            return this.slidesToShow = 2;
                                        } else {
                                            if(images > 3) {
                                                return this.slidesToShow = 3;
            ...
            replaceDiscountRate();
            bundleSlider();
            if(($('.layout_style_1170 ').length) || ($('.layout_style_fullwidth.product_layout_skin_1').length) || ($('.layout_style_flower.product_layout_skin_1').length) || ($('.layout_style_suppermarket.product_layout_supermarket').length) ){
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    var curMega = $('.site-nav'),
                                        ...
                                        if ($('.wrapper_header_supermarket:not(.wrapper_header_08)').length && $('.vertical-menu').length){
